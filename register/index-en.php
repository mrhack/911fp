  ...
  (function() {
    ...
    <script>
		...
		function validateForm() {
				...
				if($("input[name='f_lastname']").val() == "") {
					err = true;
					$("input[name='f_lastname']").addClass("error");
				} else {
					$("input[name='f_lastname']").removeClass("error");
				}				
...
#err { position: absolute; top: 8px; text-align: left; left: 20px; color: #F00; display: none; }
        ...
        <section>
          ...
          <div id="form-wrapper">
            <div id="content" style="width: 540px; color: #7c7c7c;">
              <p><strong>Fascination Porsche is returning to China with a brand new exhibition to showcase some of its most iconic historical models alongside the newest additions to its model line.</strong></p><br/>
            ...
            <br/>
                <span style="color: #ed1b23; font-size: 26px; font-weight:bold;"><img src="images/h1-en.jpg" width="540" height="23"></span>
              </p>
            ...
            <div id="form">
              <form id="regform" name="regform" method="get" action="http://182.255.24.198/porsche/process.php">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td height="55" align="left" valign="middle" style="font-size: 16px;"><span style="padding-left: 22px;">Fill in personal information</span> <div id="btn-lang"><a href="index.php">中文</a></div></td>
                  </tr>
                  <tr>
                    <td height="246" align="left" valign="middle"><table cellpadding="0" cellspacing="0" style="margin-left:22px; color:#FFF;">
                      ...
                      <tr>
                        <td>Last Name: </td>
                        <td width="20"></td>
                        <td><input type="text" name="f_lastname" /></td>
                        <td></td>
                      </tr>
                      <tr>
                        <td height="5"></td>
                      ...
                      <tr>
                        ...
                        <td><span><input id="f_sex_1" name="f_sex" type="radio" value="m" checked>
                          <label for="f_sex_1">Male</label></span>&nbsp;&nbsp;&nbsp;
                          <span><input id="f_sex_2" type="radio" name="f_sex" value="f">
                          <label for="f_sex_2">Female</label></span></td>
                        <td></td>
                      </tr>
                      <tr>
                        <td height="5"></td>
                      ...
                      <tr>
                        <td align="left" valign="top">Participating<br/>City :</td>
                        <td width="20"></td>
                        <td><span><input id="f_location_1" name="f_location" type="radio" value="sh" checked>
                          <label for="f_location_1">Shanghai, 16 June, 2013</label></span><br>
                          <span><input id="f_location_2" name="f_location" type="radio" value="bj">
                          <label for="f_location_2">Beijing, 30 June, 2013</label></span></td>
                  ...
                  <tr>
                    ...
                    <div style="position:relative;">
                    	<div id="err">Please fill in the <br/> correct information</div>
                    </div>
                    
                    <a id="btnSubmit" href="javascript:void(0)" onclick="validateForm()"><span>Submit</span></a> 
